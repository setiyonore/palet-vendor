...
class PengembalianPaletResource extends Resource
{
            ...
            ->schema([
                    ...
                    ->schema([
                        Select::make('peminjaman_manual_id')
                            ...
                            ->relationship(
                                ...
                                // Hanya tampilkan peminjaman manual yang belum kembali
                                modifyQueryUsing: fn(Builder $query, ?Model $record) => $query
                                    ->where('status', 0)
                                    // Saat edit, pastikan record yg dipilih tetap ada di daftar
                ...
                Section::make('Informasi Peminjaman')
                    ->schema(function (Get $get) {
                        ...
                        $record = PeminjamanManual::with('gudangPalet')->find($peminjamanId);
                        if (!$record) return [];
    ...
    /**
     * Memfilter tabel agar hanya menampilkan pengembalian dari Peminjaman Manual.
     */
