...
use BezhanSalleh\FilamentShield\FilamentShieldPlugin; // <-- 1. Tambahkan use statement untuk Shield
use Filament\Http\Middleware\Authenticate;
// use Filament\Http\Middleware\AuthenticateSession; // AuthenticateSession di-import ganda, hapus salah satu
